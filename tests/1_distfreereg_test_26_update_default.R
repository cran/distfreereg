...
identical(dfr_2a[-c(1,13,14)], dfr_2b[-c(1,13,14)])# TRUE; changing X requires recalculating ordering
...
identical(dfr_4a[-1], dfr_4b[-1])# TRUE
...
identical(dfr_5a[-1], dfr_5b[-1])# TRUE
...
identical(dfr_6a[-1], dfr_6b[-1])# FALSE
identical(dfr_6a[-1], dfr_6c[-1])# TRUE
...
identical(dfr_7a[-1], dfr_7b[-1])# FALSE
identical(dfr_7a[-1], dfr_7c[-1])# TRUE
...
identical(dfr_8a[-1], dfr_8b[-1])# FALSE
identical(dfr_8a[-1], dfr_8c[-1])# TRUE
...
identical(dfr_9a[-1], dfr_9b[-1])# FALSE
identical(dfr_9a[-1], dfr_9c[-1])# TRUE
...
identical(dfr_10a[-1], dfr_10b[-1])# TRUE
...
identical(dfr_11a[-1], dfr_11b[-1])# FALSE
identical(dfr_11a[-1], dfr_11c[-1])# TRUE
